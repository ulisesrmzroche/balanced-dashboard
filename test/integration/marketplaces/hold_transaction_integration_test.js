...
test('renders a modal dialog', function (assert) {
    ...
    assert.ok($modal_dialog.hasClass("modal-dialog"), "modal dialog should have rendered");
});

test('modal dialog renders the heading successfully', function (assert) {
    var $dialog_heading= $(".modal-dialog").find(".heading");
...
test('modal dialog renders the body copy successfully', function(assert){
    var $body_copy = $(".modal-dialog").find(".body-copy");
...
test('modal dialog can be confirmed', function(assert){
    var $success_action = $(".modal-dialog").find(".user-actions").find(".confirm");
...
test('modal dialog can be closed', function(assert){
    var $close_action = $(".modal-dialog").find(".user-actions").find(".close");
